...
#     for i in range(404):
#         symptoms_list.append(f.readline()[:-1])

# start of streamlit UI
st.markdown("## HealthGuardian - The Smart health predictor")
st.write("Health Guardian is a health predictor app that uses machine learning to diagnose users for diseases after a user provides symptoms that they are experiencing.")
...
prediction_value = [0 for i in range(404)]
for sym in symptoms:
...
if st.button("Evaluate"):
    with st.spinner('Predicting output...'):
        ...
        if symptoms:
            ...
            st.error(*prediction)
            st.write("Please consult your nearest health administrator, take care! 🏥")
